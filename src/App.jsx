  ...
  return (
    <div style={{ background: C.slate, minHeight: "100vh", color: "#1E293B" }}>
      ...
      <div style={{ maxWidth: 1100, margin: "0 auto", padding: "1.25rem" }}>
        {loading ? <div style={{ textAlign: "center", padding: "4rem", color: C.grayD }}><i className="ti ti-loader-2" style={{ fontSize: 32, animation: "spin 1s linear infinite", display: "block" }} /></div> : (
          <div>
            {aba === "dashboard" && (
